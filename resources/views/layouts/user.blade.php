        ...
        <nav class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
                ...
                <div class="flex justify-between h-16">
                    <div class="flex">
                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            ...
                            <x-nav-link :href="route('user.leave-requests.index')" :active="request()->routeIs('user.leave-requests.*')">
                                {{ __('My Leave Requests') }}
                            </x-nav-link>
                            <x-nav-link :href="route('user.payroll.index')" :active="request()->routeIs('user.payroll.*')">
                                {{ __('My Payroll') }}
                            </x-nav-link>
                        </div>
                    </div>
            ...
            <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
                <div class="pt-2 pb-3 space-y-1">
                    ...
                    <x-responsive-nav-link :href="route('user.attendance.index')" :active="request()->routeIs('user.attendance.*')">
                        {{ __('My Attendance') }}
                    </x-responsive-nav-link>
                    <x-responsive-nav-link :href="route('user.leave-requests.index')" :active="request()->routeIs('user.leave-requests.*')">
                        {{ __('My Leave Requests') }}
                    </x-responsive-nav-link>
                    <x-responsive-nav-link :href="route('user.payroll.index')" :active="request()->routeIs('user.payroll.*')">
                        {{ __('My Payroll') }}
                    </x-responsive-nav-link>
                </div>
